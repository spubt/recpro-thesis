...
export class KeycloakService {
  ...
  async getCurrentUserAsync(): Promise<User> {
    ...
    const recproUser = new User();
    recproUser.id = userProfile.id!;
    recproUser.firstName = userProfile.firstName!;
    recproUser.lastName = userProfile.lastName!;
    recproUser.email = userProfile.email!;
